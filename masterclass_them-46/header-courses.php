...
<head>
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/css/mycss.css" type="text/css" />
            ...
            <div id="myheader" class="header-main">
                <div class="block df jb vc">
                    ...
                    <div class="right-side">
                        <a class="btn btn-custom" href="<?php echo home_url(); ?>/my-account/">My account</a>
                        <a class="btn btn-custom" href="<?php echo home_url(); ?>">Log out</a> 
                    </div>          
                </div>
            </div>
            <div class="menu">
